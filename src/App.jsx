...
function App() {
  ...
  // Pendaftaran calon pengguna (daftar tunggu) — pakai pre-register dulu.
  if (location.pathname === '/register') {
    return <PreRegister onNavigate={(path) => navigate(path === 'overview' ? '/' : `/${path}`)} />;
  }

  // Halaman login tampil penuh tanpa navbar/footer aplikasi.
  // Registrasi mandiri sementara ditutup (lihat AuthPage) — diarahkan ke /register.
